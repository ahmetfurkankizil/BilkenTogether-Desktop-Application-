        ...
        postButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (postText.isBlank()) {
                    ...
                    StudyPost temp;
                    if (uploadedPdf != null)
                        temp = new StudyPost(2, currentUser, addAuthors, heading, postText, uploadedPdf, new Date().toString(), collection,true);
                    else
                        temp = new StudyPost(2, currentUser, addAuthors, heading, postText, null, new Date().toString(), collection,true);
