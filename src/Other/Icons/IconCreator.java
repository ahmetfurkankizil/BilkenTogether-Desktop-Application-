...
public class IconCreator extends JFrame {
    public static final File f = new File("src/Other/Icons/house-solid.png");
    ...
    public static final ImageIcon commentIcon = new ImageIcon(f.getAbsolutePath().replace("house", "comment"));
    public static final ImageIcon instructorIcon = new ImageIcon(f.getAbsolutePath().replace("house", "person-chalkboard"));
